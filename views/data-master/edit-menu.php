            ...
            <div class="card-body">
              <form action="" method="post">
                ...
                <div class="mb-3">
                  ...
                  <input type="number" name="pajak" value="<?= $data_view['pajak'] ?>" class="form-control" id="pajak" placeholder="Pajak" min="1" max="15" required>
                </div>
            ...
            <div class="card-body">
              ...
              <ol>
                <?php foreach ($view_pull_data_more as $data) {
                  echo "<li class='d-flex'><p class='me-2'>" . $data['nama_menu'] . " - Rp." . number_format($data['harga']) . " " . $data['pajak'] . "%</p><a href='edit-menu?p=" . $data['id_menu'] . "&ps=" . $data['id_tempat'] . "'><i class='bi bi-pencil-square'></i></a></li>";
                } ?>
              </ol>
            </div>
          </div>
