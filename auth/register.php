...
$_SESSION["project_portal_wisata_kafe"]["name_page"] = "Daftar";
            ...
            <div class="col-lg-6 h-100 my-auto order-1 order-lg-0">
              ...
              <div class="creative-card-body card-body p-sm-5">
                ...
                <form action="" method="post" class="w-100 mt-4 pt-2">
                  ...
                  <div class="mb-4">
                    <input type="number" name="no_telpon" class="form-control form-control-user" id="no_telpon" placeholder="No. Telpon" maxlength="13"
                      required>
                  </div>
